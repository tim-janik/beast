...
typedef enum	/*< skip >*/
{
  BSE_TYPE_PROCEDURE		= G_TYPE_RESERVED_BSE_FIRST + 1,
  BSE_TYPE_TIME			= G_TYPE_RESERVED_BSE_FIRST + 2,
  BSE_TYPE_NOTE			= G_TYPE_RESERVED_BSE_FIRST + 3,
  BSE_TYPE_DOTS			= G_TYPE_RESERVED_BSE_FIRST + 4
} BseTypeFundamentals;
typedef enum
{
  ...
  BSE_PARAM_SERVE_MASK		= 0x000f00,

  /* GUI hints */
  BSE_PARAM_HINT_RDONLY		= 1 << 16,
  BSE_PARAM_HINT_RADIO		= 1 << 17,
  BSE_PARAM_HINT_SCALE		= 1 << 18,
  BSE_PARAM_HINT_DIAL		= 1 << 19,
  BSE_PARAM_HINT_CHECK_NULL	= 1 << 20,
  BSE_PARAM_HINT_MASK		= 0xff0000,
