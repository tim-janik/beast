...
BSE_INTEGRITY_TEST (bse_test_sfi_ring_basics);
static void
bse_test_sfi_ring_basics (void)
{
...
BSE_INTEGRITY_TEST (bse_test_sfi_ring_ordering);
static void
bse_test_sfi_ring_ordering (void)
{
  SfiRing *r1 = NULL, *r2 = NULL, *t1 = NULL;
