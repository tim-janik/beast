...
protected:
  ...
  virtual double      get_normalized   () = 0;
...
public:
  ...
  virtual double       get_normalized () override                     { return wrapper_->get_normalized(); }
  virtual bool         set_normalized (double v) override             { return wrapper_->set_normalized (v); }
