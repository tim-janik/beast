...
typedef struct _BseParseHook	BseParseHook;
...
typedef void	   (*BseObjectSetParamFunc) (BseObject	   *object,
					     BseParam	   *param);
typedef GTokenType (*BseObjectParserFunc)   (BseObject	   *object,
					     BseParserData *pdata);
struct _BseObject
{
...
void		bse_object_class_add_parser	(BseObjectClass	*oclass,
						 const gchar	*token,
						 BseObjectParserFunc parser);
BseObjectParserFunc bse_object_class_get_parser	(BseObjectClass	*oclass,
						 const gchar	*token);
