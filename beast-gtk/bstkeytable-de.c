...
static BstKeyTableKey bst_key_table_de_102[] = {
  ...
  { '<',              MOD (___), MODIFY (C  ,  same,  DFLT, CONF, NEXT        ) },
  { 'a',              MOD (___), MODIFY (Cis,  same,  DFLT, CONF, NEXT        ) },
  { 'y',              MOD (___), MODIFY (D  ,  same,  DFLT, CONF, NEXT        ) },
  { 's',              MOD (___), MODIFY (Dis,  same,  DFLT, CONF, NEXT        ) },
  { 'x',              MOD (___), MODIFY (E  ,  same,  DFLT, CONF, NEXT        ) },
  { 'c',              MOD (___), MODIFY (F  ,  same,  DFLT, CONF, NEXT        ) },
  { 'f',              MOD (___), MODIFY (Fis,  same,  DFLT, CONF, NEXT        ) },
  { 'v',              MOD (___), MODIFY (G  ,  same,  DFLT, CONF, NEXT        ) },
  { 'g',              MOD (___), MODIFY (Gis,  same,  DFLT, CONF, NEXT        ) },
  { 'b',              MOD (___), MODIFY (A  ,  same,  DFLT, CONF, NEXT        ) },
  { 'h',              MOD (___), MODIFY (Ais,  same,  DFLT, CONF, NEXT        ) },
  { 'n',              MOD (___), MODIFY (B  ,  same,  DFLT, CONF, NEXT        ) },
  { 'm',              MOD (___), MODIFY (C  ,  UP  ,  DFLT, CONF, NEXT        ) },
  { 'k',              MOD (___), MODIFY (Cis,  UP  ,  DFLT, CONF, NEXT        ) },
  { ',',              MOD (___), MODIFY (D  ,  UP  ,  DFLT, CONF, NEXT        ) },
  { 'l',              MOD (___), MODIFY (Dis,  UP  ,  DFLT, CONF, NEXT        ) },
  { '.',              MOD (___), MODIFY (E  ,  UP  ,  DFLT, CONF, NEXT        ) },
  /* set lower octave without instrument (with SHIFT) */
  { '>',              MOD (S__), MODIFY (C  ,  same,  same, CONF, NEXT        ) },
  { 'A',              MOD (S__), MODIFY (Cis,  same,  same, CONF, NEXT        ) },
  { 'Y',              MOD (S__), MODIFY (D  ,  same,  same, CONF, NEXT        ) },
  { 'S',              MOD (S__), MODIFY (Dis,  same,  same, CONF, NEXT        ) },
  { 'X',              MOD (S__), MODIFY (E  ,  same,  same, CONF, NEXT        ) },
  { 'C',              MOD (S__), MODIFY (F  ,  same,  same, CONF, NEXT        ) },
  { 'F',              MOD (S__), MODIFY (Fis,  same,  same, CONF, NEXT        ) },
  { 'V',              MOD (S__), MODIFY (G  ,  same,  same, CONF, NEXT        ) },
  { 'G',              MOD (S__), MODIFY (Gis,  same,  same, CONF, NEXT        ) },
  { 'B',              MOD (S__), MODIFY (A  ,  same,  same, CONF, NEXT        ) },
  { 'H',              MOD (S__), MODIFY (Ais,  same,  same, CONF, NEXT        ) },
  { 'N',              MOD (S__), MODIFY (B  ,  same,  same, CONF, NEXT        ) },
  { 'M',              MOD (S__), MODIFY (C  ,  UP  ,  same, CONF, NEXT        ) },
  { 'K',              MOD (S__), MODIFY (Cis,  UP  ,  same, CONF, NEXT        ) },
  { ';',              MOD (S__), MODIFY (D  ,  UP  ,  same, CONF, NEXT        ) },
  { 'L',              MOD (S__), MODIFY (Dis,  UP  ,  same, CONF, NEXT        ) },
  ...
  { 'z',              MOD (___), MODIFY (A  ,  UP,    DFLT, CONF, NEXT        ) },
  ...
  { GDK_Udiaeresis,   MOD (___), MODIFY (F  ,  UP2,   DFLT, CONF, NEXT        ) },
  { GDK_apostrophe,   MOD (___), MODIFY (Fis,  UP2,   DFLT, CONF, NEXT        ) },
  ...
  { GDK_section,      MOD (S__), MODIFY (Dis,  UP,    same, CONF, NEXT        ) },
  ...
  { 'Z',              MOD (S__), MODIFY (A  ,  UP,    same, CONF, NEXT        ) },
  ...
  { GDK_Udiaeresis,   MOD (S__), MODIFY (F  ,  UP2,   same, CONF, NEXT        ) },
  { GDK_grave,        MOD (S__), MODIFY (Fis,  UP2,   same, CONF, NEXT        ) },
  /* octave shifting */  
  { '+',              MOD (___), MODIFY (same, UP  ,  same, none, none        ) },
  { '-',              MOD (___), MODIFY (same, DOWN,  same, none, none        ) },
  { '+',              MOD (_C_), MODIFY (same, UP  ,  same, none, NEXT        ) },
