...
static BstPatternEditorKey      bst_pea_ktab_us[] = {
  /* set lower octave and default instrument (0F) */
  { 'z',                MOD (000), ACT (C  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 's',                MOD (000), ACT (Cis,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'x',                MOD (000), ACT (D  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'd',                MOD (000), ACT (Dis,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'c',                MOD (000), ACT (E  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'v',                MOD (000), ACT (F  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'g',                MOD (000), ACT (Fis,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'b',                MOD (000), ACT (G  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'h',                MOD (000), ACT (Gis,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'n',                MOD (000), ACT (A  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'j',                MOD (000), ACT (Ais,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { 'm',                MOD (000), ACT (B  ,   DOWN,  0F,    0,NEXT,C_WRAP) },
  { ',',                MOD (000), ACT (C  ,   0   ,  0F,    0,NEXT,C_WRAP) },
  { 'l',                MOD (000), ACT (Cis,   0   ,  0F,    0,NEXT,C_WRAP) },
  { '.',                MOD (000), ACT (D  ,   0   ,  0F,    0,NEXT,C_WRAP) },
  { ';',                MOD (000), ACT (Dis,   0   ,  0F,    0,NEXT,C_WRAP) },
  { '/',                MOD (000), ACT (E  ,   0   ,  0F,    0,NEXT,C_WRAP) },
  /* set lower octave without instrument (with SHIFT) */
  { 'Z',                MOD (S00), ACT (C  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'S',                MOD (S00), ACT (Cis,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'X',                MOD (S00), ACT (D  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'D',                MOD (S00), ACT (Dis,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'C',                MOD (S00), ACT (E  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'V',                MOD (S00), ACT (F  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'G',                MOD (S00), ACT (Fis,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'B',                MOD (S00), ACT (G  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'H',                MOD (S00), ACT (Gis,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'N',                MOD (S00), ACT (A  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'J',                MOD (S00), ACT (Ais,   DOWN,  00,    0,NEXT,C_WRAP) },
  { 'M',                MOD (S00), ACT (B  ,   DOWN,  00,    0,NEXT,C_WRAP) },
  { '<',                MOD (S00), ACT (C  ,   0   ,  00,    0,NEXT,C_WRAP) },
  { 'L',                MOD (S00), ACT (Cis,   0   ,  00,    0,NEXT,C_WRAP) },
  { '>',                MOD (S00), ACT (D  ,   0   ,  00,    0,NEXT,C_WRAP) },
  { ':',                MOD (S00), ACT (Dis,   0   ,  00,    0,NEXT,C_WRAP) },
  ...
  { 'y',                MOD (000), ACT (A  ,   0 ,    0F,    0,NEXT,C_WRAP) },
  ...
  { '[',                MOD (000), ACT (F  ,   UP,    0F,    0,NEXT,C_WRAP) },
  { '=',                MOD (000), ACT (Fis,   UP,    0F,    0,NEXT,C_WRAP) },
  ...
  { 'Y',                MOD (S00), ACT (A  ,   0 ,    00,    0,NEXT,C_WRAP) },
  ...
  { '{',                MOD (S00), ACT (F  ,   UP,    00,    0,NEXT,C_WRAP) },
...
static guint    bst_pea_ktab_us_n_entries = (sizeof (bst_pea_ktab_us) /
                                             sizeof (bst_pea_ktab_us[0]));
