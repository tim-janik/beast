...
typedef enum /*< skip >*/
{
  ...
  BST_GENERIC_ROLL_TOOL_ALIGN,
  BST_GENERIC_ROLL_TOOL_MOVE,
  BST_GENERIC_ROLL_TOOL_DELETE,
  BST_GENERIC_ROLL_TOOL_SELECT,
  BST_GENERIC_ROLL_TOOL_VSELECT,
  BST_GENERIC_ROLL_TOOL_EDITOR,
  BST_GENERIC_ROLL_TOOL_MOVE_TICK_POINTER,
  BST_GENERIC_ROLL_TOOL_MOVE_TICK_LEFT,
  BST_GENERIC_ROLL_TOOL_MOVE_TICK_RIGHT,
} BstGenericRollTool;
